...
with open(complete_path('saved_results/selected_vars_threshold_100'), 'rb') as file:
    learning_features = pickle.load(file)
...
for channel in channel_indices:
    ...
    compute_fi_perm(model, test_channel, selection_all, learning_features, 'TEST9_sel1_test', channel)
